...
export type PolicyApiGetPolicyResponse = PolicyApiResponse<{ data: { policy: MDSPolicy } }>
export type PolicyApiGetPoliciesResponse = PolicyApiResponse<{ data: { policies: MDSPolicy[] } }>
