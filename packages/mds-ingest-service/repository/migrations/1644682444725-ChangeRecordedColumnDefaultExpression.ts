...
export class ChangeRecordedColumnDefaultExpression1644682444725 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "devices" ALTER COLUMN "recorded" SET DEFAULT mds_current_timestamp_ms()`)
    await queryRunner.query(`ALTER TABLE "events" ALTER COLUMN "recorded" SET DEFAULT mds_current_timestamp_ms()`)
    await queryRunner.query(
      `ALTER TABLE "event_annotations" ALTER COLUMN "recorded" SET DEFAULT mds_current_timestamp_ms()`
    )
    await queryRunner.query(`ALTER TABLE "telemetry" ALTER COLUMN "recorded" SET DEFAULT mds_current_timestamp_ms()`)
  }
