...
const COLUMN_TYPE: { [C in COLUMN_NAME]: string } = {
  ...
  [COLUMN.bad_events]: 'jsonb NOT NULL',
  ...
  [COLUMN.event_counts]: 'jsonb NOT NULL',
  ...
  [COLUMN.telemetry]: 'jsonb NOT NULL',
  [COLUMN.telemetry_distance_violations]: 'jsonb NOT NULL',
  ...
  [COLUMN.vehicle_counts]: 'jsonb NOT NULL',
  [COLUMN.vehicle_id]: 'varchar(255) NOT NULL',
  [COLUMN.vehicle_trips_count]: 'jsonb',
