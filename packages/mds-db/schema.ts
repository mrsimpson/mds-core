...
const COLUMN_TYPE: { [C in COLUMN_NAME]: string } = {
  ...
  [COLUMN.annotation_version]: 'smallint NOT NULL',
  ...
  [COLUMN.bad_events]: 'json NOT NULL',
  [COLUMN.base_url]: 'varchar(127) NOT NULL',
  [COLUMN.bin_size]: 'varchar(31) NOT NULL',
  ...
  [COLUMN.duration]: 'bigint NOT NULL',
  [COLUMN.effective_date]: 'bigint',
  [COLUMN.end_service_area_id]: 'uuid',
  [COLUMN.end_time]: 'bigint NOT NULL',
  [COLUMN.event_counts]: 'json NOT NULL',
  [COLUMN.event_time_violations]: 'json NOT NULL',
  [COLUMN.event_type]: 'varchar(31)',
  [COLUMN.event_type_reason]: 'varchar(31)',
  [COLUMN.events]: 'json[] NOT NULL',
  ...
  [COLUMN.sla]: 'json NOT NULL',
  [COLUMN.speed]: 'real',
  [COLUMN.start_service_area_id]: 'uuid',
  [COLUMN.start_time]: 'bigint NOT NULL',
  [COLUMN.state]: 'varchar(255)',
  [COLUMN.stop_id]: 'uuid NOT NULL',
  [COLUMN.stop_name]: 'varchar(255) NOT NULL',
  [COLUMN.telemetry]: 'json NOT NULL',
  [COLUMN.telemetry_distance_violations]: 'json NOT NULL',
