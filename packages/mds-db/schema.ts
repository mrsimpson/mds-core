...
const TABLE_KEY: { [T in TABLE_NAME]: COLUMN_NAME[] } = {
  ...
  [TABLE.reports_device_states]: [COLUMN.utc_epoch, COLUMN.device_id, COLUMN.provider_id, COLUMN.type],
...
const COLUMN_TYPE: { [C in COLUMN_NAME]: string } = {
  ...
  [COLUMN.utc_epoch]: 'bigint',
  [COLUMN.date_timezone]: 'timestamp with time zone',
