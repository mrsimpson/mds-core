import type { Device_v0_4_1, Device_v1_0_0, VEHICLE_STATE_v0_4_1, VEHICLE_STATE_v1_0_0 } from '../@types'
...
export function convert_v1_0_0_device_to_0_4_1(device: Device_v1_0_0): Device_v0_4_1 {
  const { provider_id, device_id, vehicle_id, vehicle_type, propulsion_types, year, mfgr, model, recorded, state } =
    device
  return {
    provider_id,
    device_id,
